...
result = app.invoke(
    input = {"messages": [HumanMessage(content="What are the top 5 product sales revenue by product name? Make a donut chart. Use suggested price for the sales revenue and a unit quantity of 1 for all transactions.")]}
)

result

# * MODULAR SUPERVISOR AGENT
...
# 1. Customer Segment Analysis Agent
...
# display(Image(segment_analysis_agent.get_graph().draw_png()))
...
# * NEW: Conditional Edges Based on Supervisor Decision
