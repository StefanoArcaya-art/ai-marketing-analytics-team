...
# Remove the moving averages on the last chart, and add a bollinger band with 20-day moving average
...
RECURSION_LIMIT = st.sidebar.number_input(
    "Choose Recursion Limit",
    ...
    with st.spinner("Thinking..."):
        ...
        try: 
            result = app.invoke(
                ...
                config = {"recursion_limit": RECURSION_LIMIT, "configurable": {"thread_id": "1"}},
            )
