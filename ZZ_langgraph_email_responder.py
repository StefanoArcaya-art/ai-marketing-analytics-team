# https://colab.research.google.com/drive/1WemHvycYcoNTDr33w7p2HL3FF72Nj88i?usp=sharing#scrollTo=kdCacWeLiQL5
...
# result_web_search = web_search_tool.invoke({"query": "Weather of Pittsburgh in May"})

# result_web_search[0]['content']
...
# result_research_router = research_router.invoke({"initial_email": EMAIL, "email_category":email_category})

# print(result_research_router)
...
# result_search_keywork = search_keyword_chain.invoke({"initial_email": EMAIL, "email_category":email_category})

# pprint(result_search_keywork)
...
# result_draft_writer = draft_writer_chain.invoke({"initial_email": EMAIL, "email_category":email_category,"research_info":research_info})

# pprint(result_draft_writer)
...
# pprint(final_email['final_email'])
...
# Image(app.get_graph().draw_png()) # requires pygraphviz
...
EMAIL = """
Hi, 
Is it possible to get an upgraded room at the Marriott Hotel in Pittsburgh? Also what's the weather going to be like end of May?

Thanks, 
Bill
"""

# run the agent streaming (for debugging)
